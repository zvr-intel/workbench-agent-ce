...
class ProjectsClient:
    ...
    Handles all project-related operations (list, create, update, reports)
    ...
    def list_projects(self) -> List[Dict[str, Any]]:
        ...
        Returns:
            List[Dict[str, Any]]: List of project dictionaries including:
            - id: Project ID (int)
    ...
    def get_all_scans(self, project_code: str) -> List[Dict[str, Any]]:
        """
        Retrieves the list of scans within a project.
    ...
    def create(
        ...
        """
        Create a new project in Workbench using the API's create action.

        For easy "find or create" patterns, use ResolverService instead.
        ...
        Note:
            ...
            - This method does not check for existing projects.
        """
    ...
    def update(
        ...
        Raises:
            ProjectNotFoundError: If the project doesn't exist
            ApiError: If update fails (invalid date, missing required field)
            NetworkError: If there are network issues
    ...
    def generate_report(self, payload_data: Dict[str, Any]) -> int:
        ...
        For most use cases use ReportService.generate_project_report() instead.
