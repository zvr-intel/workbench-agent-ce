"""
Functional tests for scan-git workflow.

Tests the complete end-to-end workflow:
scan-git → show-results → evaluate-gates → download-reports → delete-scan (cleanup)
"""
